...
console.log('This script populates some music, performers, genres and musicinstances to your database. Specified database as argument - e.g.: populatedb mongodb+srv://cooluser:coolpassword@cluster0.a9azn.mongodb.net/local_library?retryWrites=true');
...
function authorCreate(first_name, family_name, d_birth, d_death, cb) {
  ...
  author.save(function (err) {
    ...
    console.log('New Performer: ' + author);
    authors.push(author)
    cb(null, author)
  }  );
}
...
function bookInstanceCreate(book, imprint, due_back, status, cb) {
  ...
  bookinstance.save(function (err) {
    if (err) {
      console.log('ERROR CREATING MusicInstance: ' + bookinstance);
      cb(err, null)
      return
    }
    console.log('New MusicInstance: ' + bookinstance);
...
function(err, results) {
    if (err) {
        ...
        console.log('MusicInstances: '+bookinstances);
